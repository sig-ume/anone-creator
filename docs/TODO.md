...
### 3. PoW difficulty値の決定

**問題**: 難易度が低すぎると効果なし、高すぎるとUX悪化

**検討事項**:
- difficulty=4: 約65,000回の試行（数秒）
- difficulty=5: 約1,000,000回の試行（数十秒）
...
### Q3. Prisma vs SQLite直接

Job管理のみなら Prisma はオーバーキルか？
→ 将来拡張を考えるとPrismaが無難
